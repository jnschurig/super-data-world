...
COMMENT ON COLUMN game.action_type.action_modifier IS 'When the action is picked, it uses the modifier number as the weight. And anything with a higher value is a N out of P situation. So a scope of 10 will have a 10 out of 500 chance of activating a vocation change';
...
(
 ...
 effect_readout_text varchar(100) NULL,
